...
class YoloV1(tf.keras.Model):
  ...
  def create_conv_seq(self, img_size, in_channels):
    ...
    ########
    #Block 1
    model.add(Conv2D(filters=64, kernel_size=(7,7), strides=(2, 2), padding="valid", activation=None, input_shape=(img_size, img_size, in_channels)))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="valid"))
    model.add(BatchNormalization())
    ########
    #Block 2
    model.add(Conv2D(filters=192, kernel_size=(3,3), strides=(1, 1), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="valid"))
    model.add(BatchNormalization())
    #######
    #Block 3
    model.add(Conv2D(filters=128, kernel_size=(1,1), strides=(1, 1), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(Conv2D(filters=256, kernel_size=(3,3), strides=(1, 1), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(Conv2D(filters=256, kernel_size=(1,1), strides=(1, 1), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(Conv2D(filters=512, kernel_size=(3,3), strides=(1, 1), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="valid"))
    model.add(BatchNormalization())
    ...
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(Conv2D(filters=512, kernel_size=(1,1), strides=(1, 1), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(Conv2D(filters=1024, kernel_size=(3,3), strides=(1, 1), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2), padding="valid"))
    model.add(BatchNormalization())
    ...
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    model.add(Conv2D(filters=1024, kernel_size=(3,3), strides=(2, 2), padding=("same"), activation=None))
    model.add(BatchNormalization())
    model.add(HIDDEN_LAYER_ACTIVATION)
    #######
    #Block 6
